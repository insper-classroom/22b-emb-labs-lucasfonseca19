...
int main(void)
{
	...
	while (1)
	{
		...
		// Se usuario aperta comeca um timer
		if !(but_flag)
		{
			//enquanto o valor de but_flag for 0, aumentamos o delay em 100ms e mostramos na tela
			delay += 100;
			delay_ms(1000);
		}
		else
		{
			//se o valor de but_flag for 1, diminuimos o delay em 100ms e mostramos na tela
			delay -= 100;
			delay_ms(1000);
		}
