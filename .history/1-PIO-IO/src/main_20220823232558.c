...
int main(void)
{
	...
	// Configura Pinos
	pio_configure(LED_PIO1, PIO_OUTPUT_0, LED_IDX_MASK, PIO_DEFAULT);
	pio_configure(BUT_PIO1, PIO_INPUT, BUT_IDX_MASK, PIO_PULLUP);
	pio_configure(LED_PIO2, PIO_OUTPUT_0, LED_IDX_MASK, PIO_DEFAULT);
	pio_configure(BUT_PIO2, PIO_INPUT, BUT_IDX_MASK, PIO_PULLUP);
	pio_configure(LED_PIO3, PIO_OUTPUT_0, LED_IDX_MASK, PIO_DEFAULT);
	pio_configure(BUT_PIO3, PIO_INPUT, BUT_IDX_MASK, PIO_PULLUP);
