...
{
	// *p_pio é um endereço de memória no qual o PIO em questão está mapeado
	// ul_mask é a máscara na qual iremos aplicar ao registrador que controla
	// os pinos para colocarmos 1 na saída
