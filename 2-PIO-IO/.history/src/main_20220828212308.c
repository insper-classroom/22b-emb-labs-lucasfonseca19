...
{
	//The selection between glitch filtering or debouncing is done by PIO_IFSCDR
	//and PIO_IFSCER.
	//The selection between pull-up or pull-down is done by PIO_PUDR and
	//PIO_PUER.
	//The selection between the internal filter or the internal pull-up is done
	//by PIO_IFER and PIO_IFDR.
