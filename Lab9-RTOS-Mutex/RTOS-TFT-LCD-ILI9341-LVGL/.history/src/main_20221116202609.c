...
void lv_termostato(void)
{
	...
	lv_obj_t *btn1 = lv_btn_create(lv_scr_act());
	lv_obj_add_event_cb(btn1, event_handler, LV_EVENT_ALL, NULL);
	lv_obj_align(btn1, LV_ALIGN_BOTTOM_LEFT,1,0);
	...
	lv_obj_t *btn2 = lv_btn_create(lv_scr_act());
	lv_obj_add_event_cb(btn2, event_handler, LV_EVENT_ALL, NULL);
	lv_obj_align(btn2, LV_ALIGN_BOTTOM_LEFT,45,0);	
	...
	lv_obj_align(btn3, LV_ALIGN_BOTTOM_LEFT,90,0);
	...
	lv_obj_align(btn4, LV_ALIGN_BOTTOM_LEFT,200,0);
	...
	lv_obj_align(btn5, LV_ALIGN_BOTTOM_LEFT,245,0);
