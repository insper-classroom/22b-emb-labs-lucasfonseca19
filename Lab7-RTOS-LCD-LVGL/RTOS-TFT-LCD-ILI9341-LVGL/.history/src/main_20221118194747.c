...
static void clk_handler(lv_event_t * e) {
	...
	if (xSemaphoreTake(xSemaphore, 500 / portTICK_PERIOD_MS) == pdTRUE) {
		// pega a hora e os minutos atuais do rtc e atualiza o label
		calendar t;
		t.hour = 0;
		t.minute = 0;
		t.seccond = 0;
...
void lv_termostato(void)
{
	...
	lv_obj_set_style_text_font(labelClock, &desg20_hh_mm, LV_STATE_DEFAULT);
